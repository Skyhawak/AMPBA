...
st.markdown("""
    <h1 style='text-align: center; color: white; margin-bottom: 0px;'>Demand Forecasting & Optimization of Supply Chain</h1>
    <h2 style='text-align: center; color: white; margin-top: 0px;'>Wooden Pallets</h2>
    """, unsafe_allow_html=True)
